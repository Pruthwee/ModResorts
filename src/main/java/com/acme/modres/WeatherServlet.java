...
public class WeatherServlet extends HttpServlet {
  ...
  private String configureEnvDiscovery() {
    ...
    String serverEnv = "Server information not available";
    return serverEnv;
  }

  private InitialContext setInitialContextProps() {
    // Fixed raw type usage - added generic type parameter
    Hashtable<String, String> ht = new Hashtable<>();

    // Note: WebSphere-specific JNDI configuration
    // This may need adjustment for other application servers
