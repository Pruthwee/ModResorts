...
class AvailabilityCheckerServletTest {
    ...
    @Test
    void testDoGet_withValidDate_returnsAvailability() throws IOException, ServletException {
    ...
    @Test
    void testDoGet_responseContentType() throws IOException, ServletException {
        when(request.getParameter("date")).thenReturn("08/15/2024");
    ...
    @Test
    void testDoGet_writesJsonResponse() throws IOException, ServletException {
        when(request.getParameter("date")).thenReturn("08/15/2024");
